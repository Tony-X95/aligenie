...
public class ConstantKey {
    ...
    public static final String OAUTH_CLIENT_CALLBACK = "http://localhost:8080/homeinns-web/client/oauth_callback";
    public static final String OAUTH_CLIENT_AUTHORIZE = "http://localhost:8080/homeinns-web/oauth2/authorize";
    public static final String OAUTH_CLIENT_ACCESS_TOKEN = "http://localhost:8080/homeinns-web/oauth2/access_token";
    public static final String OAUTH_CLIENT_GET_RESOURCE = "http://localhost:8080/homeinns-web/oauth2/get_resource";
}
